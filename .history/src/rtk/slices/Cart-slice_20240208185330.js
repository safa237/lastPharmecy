...
export const fetchCart = createAsyncThunk('cartSlice/fetchCart',async (bearerToken)=>{
        const language = 'en'; 
        const bearerToken = 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyLjFAZ21haWwuY29tIiwiaWF0IjoxNzA3MzY3MjM1LCJleHAiOjE3MDc0NTM2MzV9.KGFlNVT3_QKmI6fpbxawDvBVUXB_WVvUmIOiVsBRxQY'
