          ...
          <div className="flexNav">
            <div className="flexNavone">
              ...
              <div className="flexRightNav">
                ...
                <div className="text-line text-linelogout outline-dashed">
                  {isLoggedIn && (
                    <>
                      <div className="relative  outline-dotted w-[40px] h-[40px] flex flex-row">
                        <IoIosNotificationsOutline
                          className=" "
                          onClick={handleNotificationsClick}
                        />
                        <div className="w-[20px] h-[20px] rounded-full bg-red-500 absolute text-sm">
