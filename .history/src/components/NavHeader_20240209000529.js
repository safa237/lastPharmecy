            ...
            <div className="flexNavone">
              ...
              <div className="flexRightNav">
                ...
                <div className="text-line text-linelogout">
                  {isLoggedIn && (
                    <>
                      <div onClick={handleNotificationsClick} className="outline-dashed relative">
                        <IoIosNotificationsOutline
                          className="noteicon"
                          
                        />
                        <div className=" lg:top-9  w-10 h-10 rounded-full bg-red-500 absolute text-center items-center py-1 text-white opacity-70 absolute">
