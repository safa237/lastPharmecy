            ...
            <div className="flexNavone">
              ...
              <div className="flexRightNav">
                ...
                <div className="text-line text-linelogout">
                  {isLoggedIn && (
                    <>
                      <div onClick={handleNotificationsClick} className="outline-dashed relative overflow-visible">
                        <IoIosNotificationsOutline
                          className="noteicon"
                          
                        />
                        {notifications.length >0 ?           <div className=" top-2  w-10 h-10 rounded-full bg-red-500 text-center items-center text-white opacity-70 absolute">
                      ...
                      <div className="notification-dropdown-container">
                        {showNotifications && (
                          <div className="notification-dropdown">
                            ...
                            <button className="w-full items-center mx-auto text-center my-2 pt-1 rounded-md bg-slate-300 text-blue-600 h-9 "
